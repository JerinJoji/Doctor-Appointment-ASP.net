                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/iconcalendar.png" Height="21px" Width="19px" OnClick="ImageButton1_Click" />
                                <asp:Calendar ID="CalendarDoa" runat="server" BackColor="White" BorderColor="Black" DayNameFormat="Shortest" Font-Names="Times New Roman" Font-Size="10pt" ForeColor="Black" Height="220px" NextPrevFormat="FullMonth" TitleFormat="Month" Width="243px" OnDayRender="CalendarDoa_DayRender">
